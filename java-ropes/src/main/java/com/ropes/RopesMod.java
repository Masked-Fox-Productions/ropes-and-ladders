package com.ropes; // SETUP: Replace with your package

import com.ropes.block.ModBlocks; // SETUP: Replace package
...
public class RopesMod implements ModInitializer {

    public static final String MOD_ID = "ropes"; // SETUP: Replace with your mod ID
